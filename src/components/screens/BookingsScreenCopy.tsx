/**
 * Class preview — bookings list with class preview bottom sheet (Figma 5338:4709).
 *
      ...
      <div className="cp-sheet__main">
        <header className="cp-sheet__header">
          <div className="cp-sheet__title-block">
            <h2 className="cp-sheet__title">Stretch</h2>
            <p className="cp-sheet__meta">John Sega</p>
            <p className="cp-sheet__meta">10:00 am, Thursday 3 April</p>
            <p className="cp-sheet__meta">45 minutes</p>
          </div>
        ...
        <div className="cp-sheet__footer">
          <button
            ...
            style={{ '--cp-book-btn-icon': `url(${calendarAddIcon})` } as React.CSSProperties}
          >
...
interface BookingsScreenCopyProps {
  mode: PreviewMode;
}

export function BookingsScreenCopy({ mode }: BookingsScreenCopyProps) {
  return (
